...
function Identification() {
  ...
  const handleBackClick = () => {
    if (showPayment) {
      ...
      // Se está na página de identificação, voltar para checkout
      navigate('/checkout');
    }
  };
                  ...
                  {cartProducts.length > 0 && (
                    <>
                      ...
                      <div className="identification-product-overlay identification-product-center">
                        <img 
                          src={productImages[cartProducts[0].image] || productImages.product1} 
                      ...
                      {cartProducts.length > 1 && (
                        <div className="identification-product-overlay identification-product-right">
                          <img 
                            src={productImages[cartProducts[1].image] || productImages.product1} 
                      ...
                      {cartProducts.length > 2 && (
                        <div className="identification-product-overlay identification-product-left">
                          <img 
                            src={productImages[cartProducts[2].image] || productImages.product1} 
